    ...
    <div className="bg-gradient-to-r from-secondary-brand/5 to-survey-info/5 rounded-lg p-6 space-y-4 border border-secondary-brand/10">
      ...
      <div className="bg-survey-info-light/30 border border-survey-info/20 rounded-lg p-3">
        <p className="text-xs text-survey-info flex items-start gap-2">
          ...
          <span>
            <strong>Tip:</strong> Start with "All Users" for maximum reach, then
            refine your targeting based on response data. Segment targeting can
            increase relevance but may reduce overall responses.
          </span>
        </p>
      </div>
          ...
          <div className="space-y-4 ml-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <SlimSwitch
                ...
                onCheckedChange={(checked) =>
                  onSettingsChange("userTargeting.returningCustomer", checked)
                }
              />
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <SlimSwitch
                  checked={settings.productPurchase.selectedProducts.length > 0}
