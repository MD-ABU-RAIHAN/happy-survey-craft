...
interface SurveyPreviewProps {
  ...
  distributionType: 'post-purchase' | 'onsite' | 'exit-intent' | 'email' | 'branded-survey';
  ...
  const getBrandedBackgroundStyle = () => {
    ...
    if (background.type === 'solid') {
      ...
      if (background.overlay) {
        ...
        style.background = `linear-gradient(rgba(${parseInt(overlayColor.slice(1, 3), 16)}, ${parseInt(overlayColor.slice(3, 5), 16)}, ${parseInt(overlayColor.slice(5, 7), 16)}, ${overlayOpacity}), rgba(${parseInt(overlayColor.slice(1, 3), 16)}, ${parseInt(overlayColor.slice(3, 5), 16)}, ${parseInt(overlayColor.slice(5, 7), 16)}, ${overlayOpacity})), url(${background.imageUrl})`;
      }
    }
  ...
  return (
    <Card className="h-fit">
      ...
      <CardContent>
        ...
        style={distributionType === 'branded-survey' ? getBrandedBackgroundStyle() : { backgroundColor: 'white' }}>

          {/* Progress Bar */}
          {distributionType === 'branded-survey' && brandedSurveySettings?.progressBar.enabled &&
           brandedSurveySettings.progressBar.position === 'top' && (
            <div
              className="w-full h-1"
              style={{ backgroundColor: brandedSurveySettings.progressBar.backgroundColor }}
            >
              <div
          ...
          {/* Side Logo */}
          {distributionType === 'branded-survey' && brandedSurveySettings?.sideLogo.enabled &&
           brandedSurveySettings.sideLogo.url && (
            <div
              className={`absolute top-4 z-10 ${
                brandedSurveySettings.sideLogo.position === 'left' ? 'left-4' : 'right-4'
              }`}
            >
              <img
                ...
                alt="Brand logo"
                className={`${
                  brandedSurveySettings.sideLogo.size === 'small' ? 'h-6' :
                  brandedSurveySettings.sideLogo.size === 'medium' ? 'h-8' : 'h-10'
                } object-contain`}
              />
            </div>
          )}
          ...
          {/* Survey Header */}
          <div className={`${distributionType === 'branded-survey' ? '' : getPreviewStyle()} p-6 relative`}
               style={distributionType === 'branded-survey' ? getBrandedTextStyle() : {}}>

            {/* Header Logo for Branded Survey */}
            {distributionType === 'branded-survey' && brandedSurveySettings?.headerLogo.enabled &&
             brandedSurveySettings.headerLogo.url && (
              <div className={`mb-4 flex ${
                brandedSurveySettings.headerLogo.position === 'left' ? 'justify-start' :
                brandedSurveySettings.headerLogo.position === 'center' ? 'justify-center' : 'justify-end'
              }`}>
                <img
                  src={brandedSurveySettings.headerLogo.url}
                  alt="Header logo"
                  className={`${
                    brandedSurveySettings.headerLogo.size === 'small' ? 'h-8' :
                    brandedSurveySettings.headerLogo.size === 'medium' ? 'h-12' : 'h-16'
                  } object-contain`}
                />
              </div>
            )}
            ...
            <div className="space-y-2">
              <h3
                ...
                style={distributionType === 'branded-survey' && brandedSurveySettings ?
            ...
            {questions.length === 0 ? (
              ...
              <div className="space-y-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          <p
                            ...
                            style={distributionType === 'branded-survey' && brandedSurveySettings ?
                              { color: brandedSurveySettings.section.primaryTextColor } : {}
                            }
                          >
                            {question.title}
                          </p>
                        ...
                        <div className="space-y-2">
                          <Input
                            ...
                            placeholder={
                              ...
                              (question.type === 'email' ? 'your.email@example.com' :
                               question.type === 'phone' ? '+1 (555) 123-4567' : 'Your answer...')
                            }
                            className="h-8 text-sm"
                            disabled
                          />
                ...
                <div className="pt-4 space-y-3">
                  <Button
                    className="w-full"
                    style={distributionType === 'branded-survey' ? getButtonStyle() : {}}
                  >
                    Submit Survey
                  ...
                  {/* Trust Signals */}
                  {distributionType === 'branded-survey' && brandedSurveySettings?.trustSignals && (
                    <div className="flex justify-center items-center space-x-4 pt-2">
                      ...
                      {brandedSurveySettings.trustSignals.showPrivacyBadge && (
                        <div className="flex items-center space-x-1">
